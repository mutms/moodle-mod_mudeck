...
$string['print_slides_help'] = 'Every slide on its own page, without the speaker notes. Saved as a PDF, it is a copy of the whole presentation that opens anywhere.';
